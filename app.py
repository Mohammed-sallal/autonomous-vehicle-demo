...
st.markdown("""
    <style>
        ...
        .stApp, p, label, .stMarkdown, .stText, h2, h3, h4, h5, h6, li, span {
        ...
        /* 1. The Thumb (Draggable Circle) - Force Teal */
        ...
        /* 2. The Active Track (Filled part) - Force Slate/Teal */
        div[data-testid="stSlider"] div[data-baseweb="slider"] > div > div > div:first-child {
            background-color: #45a29e !important;
        }
        
        /* 3. The Inactive Track (Empty part) */
        div[data-testid="stSlider"] div[data-baseweb="slider"] > div > div {
            background-color: rgba(255, 255, 255, 0.2) !important;
        }
        
        /* 4. The Value Label (Popup number) - Force Teal Text */
        div[data-testid="stSlider"] div[data-testid="stMarkdownContainer"] p {
            color: #66fcf1 !important;
        }
        
        /* 5. The Min/Max Labels (0.0 / 1.0) - Force Teal Text */
